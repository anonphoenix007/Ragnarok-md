...
smd({
    ...
    try {
        ...
        if (!_0x1b0897) {
            return _0x42b3b8.reply("Provide me a query ex Who is asta");
        }
...
smd({
    ...
    try {
        ...
        if (_0x48975a[0]) {
            ...
            ᴀsᴛᴀ_ᴍᴅ_AnonyMsg[_0x3e1b1c] = new AnonymousMsg();
            let _0x3079e2 = ᴀsᴛᴀ_ᴍᴅ_AnonyMsg[_0x3e1b1c];
    ...
    try {
        if (_0x2acf30.quoted && isAnnonyMsgAlive.includes(_0x2acf30.sender) && _0x2acf30.text.length > 2) {
            ...
            if (_0x2acf30.reply_text.includes("ᴀsᴛᴀ-ᴍᴅ • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[0].includes("ᴀsᴛᴀ-ᴍᴅ • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[2].includes("Msg_Id")) {
                ...
                let _0x2ecd2a = ᴀsᴛᴀ_ᴍᴅ_AnonyMsg[_0x1b0d01];
                if (!_0x2ecd2a) {
                    return;
                }
                try {
                    if (_0x2ecd2a) {
                        ...
                        if (_0x13a11c.toLowerCase().startsWith("reply")) {
                            ...
                            if (_0x2ecd2a.howmanyreply >= 2) {
                                isAnnonyMsgAlive = isAnnonyMsgAlive.replace("," + _0x2acf30.sender, "");
                                delete ᴀsᴛᴀ_ᴍᴅ_AnonyMsg[_0x1b0d01];
                            }
